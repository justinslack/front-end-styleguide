#African up front-end style guide

In working on large, long running projects with many developers it is
important that we all work in a unified way in order to:
